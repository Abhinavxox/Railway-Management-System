...
public class passengerLoginFrame extends JFrame {
	...
	public passengerLoginFrame() {
		...
		contentPane.add(getLblRegisterNow());
		contentPane.add(getLblIfYouDont());
	...
	private JLabel getLblIfYouDont() {
		if (lblIfYouDont == null) {
			lblIfYouDont = new JLabel("If you don't have an account");
			lblIfYouDont.setHorizontalAlignment(SwingConstants.CENTER);
			lblIfYouDont.setForeground(Color.BLACK);
			lblIfYouDont.setFont(new Font("Press Start 2P", Font.PLAIN, 10));
			lblIfYouDont.setBounds(264, 490, 352, 36);
		}
		return lblIfYouDont;
	}
	private JLabel getLblRegisterNow() {
		if (lblRegisterNow == null) {
			lblRegisterNow = new JLabel("Register Now");
			...
			lblRegisterNow.setHorizontalAlignment(SwingConstants.CENTER);
			lblRegisterNow.setForeground(Color.GRAY);
			lblRegisterNow.setFont(new Font("Press Start 2P", Font.PLAIN, 10));
			lblRegisterNow.setBounds(264, 520, 352, 29);
		}
		return lblRegisterNow;
	}
	...
	private JLabel getLblLogin_1() {
		if (lblLogin_1 == null) {
			...
			lblLogin_1.setBounds(330, 416, 229, 77);
		}
		return lblLogin_1;
	}
